--  CREATE USERS
INSERT INTO users (email, password) VALUES ("admin@studydeck.com", "5911211b41ad0fc56b09e05fe73ee5cedd42ca23");
INSERT INTO users (email, password) VALUES ("scott@studydeck.com", "5911211b41ad0fc56b09e05fe73ee5cedd42ca23");
INSERT INTO users (email, password) VALUES ("nicolo@studydeck.com", "5911211b41ad0fc56b09e05fe73ee5cedd42ca23");
INSERT INTO users (email, password) VALUES ("steve@studydeck.com", "5911211b41ad0fc56b09e05fe73ee5cedd42ca23");
...
-- Formerly: type 1 = recently viewed, type 2 = user created, type 3 = user saved
-- Studydeck GRE: 
--   Types are ignored on dashboard, but if a user created the deck then it shows
--   up in "User Created Decks" 
--   Any other associations in the my_decks table show up as premium decks regardless of type
--
-- Admin user
INSERT INTO my_decks (user_id, deck_id, type, quiz_count, created) VALUES (1,1,3,0,NOW());
...
INSERT INTO my_decks (user_id, deck_id, type, quiz_count, created) VALUES (1,4,3,0,NOW());
-- Top 500 deck, Latin Roots
INSERT INTO my_decks (user_id, deck_id, type, quiz_count, created) VALUES (1,5,2,0,NOW());
INSERT INTO my_decks (user_id, deck_id, type, quiz_count, created) VALUES (1,6,2,0,NOW());
...
INSERT INTO my_decks (user_id, deck_id, type, quiz_count, created) VALUES (3,4,3,0,NOW());
-- Top 500 deck, Latin Roots
...
-- from another SQL file

-- deck 6: Studydeck Latin Roots
-- from another SQL file
