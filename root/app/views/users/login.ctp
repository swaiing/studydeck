...
-->
	...
	<?php
        ...
        // Start DIV
    	echo "<div id=\"login_box\" class=\"sbox_inner\">\n";
    	echo "<h2>Login to Studydeck</h2>\n";
    	...
    	echo "<ol>\n";
    	echo "<li>" . $form->input('email',array('label'=>'Email', 'size'=>$FIELD_SIZE, 'maxLength'=>$FIELD_LENGTH)) . "</li>\n";
